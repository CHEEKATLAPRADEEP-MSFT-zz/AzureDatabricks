...
import scala.collection.JavaConverters._
    ...
    val testSource = List("First day collection", "Who is the winner?", "Hearty Congratulations to Annayya", "1st day collection")
    ...
    if (dataSource == "test") {
      ...
      val query = new Query(" #SyeraaNarashimaReddy ")
      query.setCount(100)
      query.lang("en")
      var finished = false
      while (!finished) {
